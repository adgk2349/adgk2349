...
* **Self-Funded Growth:** 학술 활동 및 서포터즈 등 다양한 교내 성과를 인정받아, **2년간 누적 약 400만 원의 역량 강화 장학금 및 활동비 수령**.
* **Communication & Support:**
    * **CTL 서포터즈:** 카드뉴스 콘텐츠 제작 및 교내 커뮤니티(에타) 바이럴 마케팅, 축제 부스 운영을 주도하며 홍보 역량 발휘.
    * **국제교류원:** 외국인 유학생 안내 및 공문서 수발신, 행정 서류 처리 업무를 전담하며 꼼꼼한 행정 지원 및 소통 능력 입증.
