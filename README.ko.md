...
| 분류 | 기술 |
| --- | --- |
| 모바일 | Swift, SwiftUI, UIKit, Combine |
| AI·데이터 | Python, PyTorch, Whisper (Local/API), Prompt Engineering |
| 백엔드·인프라 | Django, Docker, Nginx, Linux (Ubuntu) |
| 협업·도구 | Git, GitHub Actions, Figma, Slack |
...
- 저장소: [PLOS-for-Mac](https://github.com/adgk2349/PLOS-for-Mac)
...
- 저장소: [FlowMap-AI_Code_Hallucination_Guard_for_Swift](https://github.com/adgk2349/FlowMap-AI_Code_Hallucination_Guard_for_Swift)
...
- 저장소: [Biblity](https://github.com/adgk2349/Biblity)
...
### 4) KDecoder for Mac
- 저장소: [KDecoder_for_Mac](https://github.com/adgk2349/KDecoder_for_Mac)
- App Store: [KDecoder: 깨진 한글 파일명 복원](https://apps.apple.com/kr/app/kdecoder-%EA%B9%A8%EC%A7%84-%ED%95%9C%EA%B8%80-%ED%8C%8C%EC%9D%BC%EB%AA%85-%EB%B3%B5%EC%9B%90/id6806795869?mt=12)
- macOS에서 발생하는 한글 파일명 깨짐(NFD/NFC) 문제를 드래그 앤 드롭 방식으로 해결하는 유틸리티입니다.
- 인코딩 정규화 로직을 구현해 실사용 관점의 파일 호환성을 개선했습니다.

### 5) SPSS Converter
- 저장소: [SPSS_Converter](https://github.com/adgk2349/SPSS_Converter)
- macOS용 드래그 앤 드롭 기반 SPSS(.sav) → CSV 변환 도구입니다.
- 다중 파일 처리 시나리오를 고려해 반복 작업 시간을 줄이는 데 집중했습니다.

### 6) ArDrone Controller for iPad
- 저장소: [ArDrone_Controller_for_iPad](https://github.com/adgk2349/ArDrone_Controller_for_iPad)
- SwiftUI + BLE 기반의 iPad 드론 컨트롤러 프로젝트입니다.
- UI/상태 제어 흐름과 하드웨어 연동을 함께 다룬 iOS 프로젝트입니다.

### 7) YouTube Looper (Safari Extension)
- 저장소: [Youtube_Looper](https://github.com/adgk2349/Youtube_Looper)
...
- Korean: Native
- Japanese: Advanced (JLPT N1 준비 중)
